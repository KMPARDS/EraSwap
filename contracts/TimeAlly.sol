...
contract TimeAlly is TimeAllyCore{
  ...
  */
  ...
  function CreateContractsByBatch(uint256 batchlength, uint256 planid, address[] memory contractOwner, uint256[] memory amount, uint256 total) public NotPaused() OnlyOwner() returns(bool) {
